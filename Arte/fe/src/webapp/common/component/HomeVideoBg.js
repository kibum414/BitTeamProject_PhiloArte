    ...
    return (
        <Loader>
            ...
            <WhatWeOfferEleven
                ...
                text="Philo_Arte는 예술대학교 학생들을 위한 서비스 플랫폼입니다. Philo_Arte는 전국 여러 예술대 학생들과 소통을 가능하게 합니다. 또한 대학 생활 간 전시, 졸업 작품, 과제 등을 당신의 커리어로 이용해보세요.
            ...
            <WhatWeDoOne tagline="What We Do" title="저작권 관리 " image={imgWhatWeDo} classes="no-bottom-line">
                Philo_Arte는 학생들의 작품의 저작권을 지켜주기 위해 언제나 노력하고 있습니다. 저희 사이트를 이용 하는 학생들 누구든지 자신이 올린 작품이 불법적인 경로로 이용당하고 있을 시 저희가 알려드리겠습니다.
            </WhatWeDoOne>
