...
import static shop.parkkibeom.api.common.util.Proxy.rangeBelowRandom;
import static shop.parkkibeom.api.common.util.Proxy.string;
...
public class DummyGenerator {
    ...
    public String makeUsername() {
        ...
        return string.apply(id).substring(0, 4);
    }
     ...
     * 어떤 해 이든지 400으로 나눈 값이 0인 것은 윤년으로 포함된다.
     * 그 외의 나머지 연도는 평년이다.
     */
